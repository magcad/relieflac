...
| Vérifications | [/test/](https://magcad.github.io/relieflac/test/) — 204 contrôles · [/test/interaction.html](https://magcad.github.io/relieflac/test/interaction.html) — 101 enchaînements |
...
test/                       204 vérifications (dont le shader rendu hors MapLibre)
                            et 101 enchaînements de l'interface
